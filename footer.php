 ...
 */
 ?>
  ...
  <div class="pie-footer container-fluid m-0">
	   <footer>
	  <div class="row">
	    <div class="col">
	    ...
	    <div class="col">
		   <h5>Contact Info</h5>
		    <p>
		      ...
		      <button type=“submit” class="pie-footer-button">Contact Us</button>
		    </p>
	    </div>
	  </div>
	  <div class="row">
	    <div class="col">
		   © 2018 Patients In Education. Developed by Code the Change Foundation.
	    </div>
	  </div>
